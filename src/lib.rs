...
#[derive(Debug)]
pub struct CurveFinanceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CurveFinanceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CurveFinance processing");
    
    let mut processor = CurveFinanceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CurveFinanceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CurveFinanceProcessor::new(false);
